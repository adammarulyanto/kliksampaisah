...
class Dashboard extends BaseController
{
    ...
    public function save_undangan()
    {
        ...
        $ownership_template_id    = $this->request->getPost('ownership_template_id');
    ...
    public function template()
    {
        ...
        // Enrich templates with feature and fit_to names
        foreach ($templates as &$template) {
            // Konversi feature dari string/postgres array ke array PHP
